  ...
  return (
    <header className="flex h-16 shrink-0 items-center justify-between border-b border-navy-800 bg-navy-950 px-6">
      <div className="flex items-center gap-4">
        <h2 className="text-lg font-medium text-text-primary hidden sm:block">
          {breadcrumb}
        </h2>
      ...
      <div className="flex items-center gap-4">
        ...
        <div className="flex items-center gap-3">
          ...
          <Link to="/profile" className="flex h-9 w-9 items-center justify-center rounded-full bg-navy-900 text-text-secondary transition-colors hover:text-text-primary hover:bg-navy-800">
            <User size={18} />
          </Link>
