...
export const Sidebar = () => {
  ...
  return (
    <aside className="sticky top-0 flex h-screen w-60 shrink-0 flex-col border-r border-navy-800 bg-navy-950">
      {/* Logo */}
      <div className="flex items-center gap-3 border-b border-navy-800 px-5 py-5">
        ...
        <div>
          <p className="font-display text-sm font-bold text-text-primary leading-none">
            E-Yantra EEP
          </p>
