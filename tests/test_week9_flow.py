...
1. Admin login -> create week9 assignment
...
week9_assignment = next((a for a in assignments if a["slug"] == "week9"), None)

if week9_assignment:
    print(f"   Found existing Week 6 Assignment: {week9_assignment['id']}")
    assignment_id = week9_assignment["id"]
else:
    slug = "week9"
    create_payload = {
        "slug": slug,
