    ...
    <div className="space-y-5">
      ...
      <div className="rounded-xl border border-navy-800 bg-surface-main p-6 shadow-card">
        <div className="mb-3 flex items-center gap-2">
          ...
          <h3 className="font-display text-base font-semibold text-text-primary">Instructions</h3>
        </div>
        <div className="rounded-lg border border-navy-800 bg-surface-inset px-5 py-4 text-sm text-text-primary leading-relaxed">
